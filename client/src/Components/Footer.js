...
function Footer() {
    ...
    return (
        ...
        <div className='footerM' style={{background:`linear-gradient(to bottom,  ${top} 80%,${bottom} 100%)`}}>
        <div className=' flex flex-col'> 
                <ul>
                <li className='smallRoboto'><a href="/">
                    <img className='footerLogoTopM' src={footerLogo} alt='esg-nrg logo' /></a></li><br/>
                <li className='smallRoboto'><a href="/about-us">About</a></li><br/>
                <li className='smallRoboto'><a href="/faq">FAQ</a></li><br/>
                <li className='smallRoboto'><a href="/projects">Projects</a></li><br/>
                <li className='smallRoboto'><a href="/our-impact">Our Impact</a></li><br/>
                <li className='smallRoboto'><a href="/contact-us">Contact Us</a></li><br/>
            ...
            <hr style={{margin: '75px'}}></hr>
                            ...
                            <div className='alignFooterM'>
                                <a href='/'><img className='footerLogoM' src={LinkedIn} alt='esg-nrg linkedin' /></a>
                                <a href='/'><img className='footerLogoM' src={Twitter} alt='esg-nrg twitter' /></a>
                                <a href='/'><img className='footerLogoM' src={Facebook} alt='esg-nrg facebook' /></a>
                                <a href='/'><img className='footerLogoM' src={Instagram} alt='esg-nrg instagram' /></a>
                            </div><br/>
                            
                            <div className='copyrightM'><em>&copy; ESG-NRG. 2021. Saving the earth one ton at a time!</em></div>
        </div>
