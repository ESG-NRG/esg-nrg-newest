...
function Hero() {
    return (
      ...
      <p className='centered'>Ships are responsible for 2-3% of the worlds CO<sub>2</sub> emissions. We need to avert emissions and pull CO<sub>2</sub> from the atmosphere.</p>
